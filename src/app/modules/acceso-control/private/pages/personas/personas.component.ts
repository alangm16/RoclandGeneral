...
export class PersonasComponent implements OnInit, OnDestroy {
  ...
  readonly tableColumns: DataTableColumn[] = [
    {
      key: 'indice',
      label: '#',
      headerClass: 'col-index',
      cellClass: 'text-mono text-muted col-index',
    },
    {
      key: 'nombre',
      label: 'Nombre',
      headerClass: 'col-nombre',
      cellClass: 'col-nombre',
    },
    {
      key: 'numeroIdentificacion',
      label: 'No. ID',
      headerClass: 'col-id',
      cellClass: 'text-mono col-id',
    },
    {
      key: 'tipoID',
      label: 'Tipo ID',
      headerClass: 'col-tipo',
      cellClass: 'col-tipo',
    },
    {
      key: 'empresa',
      label: 'Empresa',
      headerClass: 'col-empresa',
      cellClass: 'text-muted col-empresa',
    },
    {
      key: 'visitas',
      label: 'Visitas',
      headerClass: 'col-visitas',
      cellClass: 'col-visitas',
    },
    {
      key: 'ultimaVisita',
      label: 'Última Visita',
      headerClass: 'col-fecha',
      cellClass: 'text-mono text-muted col-fecha',
    },
    {
      key: 'acciones',
      label: '',
      ...
      filters: [
        {
          ...
          options: [
            { label: 'Más visitas', value: 'frecuencia' },
            { label: 'Ultimas Altas', value: 'fecha' },
            { label: 'Alfabético (A-Z)', value: 'alfabetico' },
            { label: 'Última visita', value: 'ultimavisita' },
          ],
        },
      ],
      actions: [
  ...
  cargarPersonas(): void {
    ...
    const orden = this.layoutSvc.filterValues()['orden'] || 'frecuencia';

    this.adminSvc
      .getPersonas(this.paginaActual(), this.porPagina, busqueda, orden)
  ...
  async verIdentificacion(persona: PersonaPerfilDto): Promise<void> {
    ...
    this.perfilSeleccionado.set(persona);
